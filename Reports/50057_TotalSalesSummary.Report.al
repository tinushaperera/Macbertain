report 50057 "Total Sales Summary"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/TotalSalesSummary.rdl';
    ...
    dataset
    {
        dataitem(DataItem1; Integer)
        {
            ...
            column(OprDes; TempSalesLine.Description)
            {
            }
            ...
            var
                ...
                DimenRec: Record "Dimension Value";
            begin
                TempSalesLine.RESET;
                ...
                IF BUCode <> '' THEN BEGIN
                    //SalesInvHedd.SETRANGE("Shortcut Dimension 1 Code",BUCode);
                    //SalesCredHedd.SETRANGE("Shortcut Dimension 1 Code",BUCode);
                    ...
                    SalesHedd.SETFILTER("Shortcut Dimension 1 Code", BUCode);
                END;
                IF OprCode <> '' THEN BEGIN
                    //SalesInvHedd.SETRANGE("Shortcut Dimension 2 Code",OprCode);
                    //SalesCredHedd.SETRANGE("Shortcut Dimension 2 Code",OprCode);
                    ...
                    SalesHedd.SETFILTER("Shortcut Dimension 2 Code", OprCode);
                END;
                    ...
                    REPEAT
                        ...
                        IF SalesLine.FINDSET THEN BEGIN
                            REPEAT
                                ...
                                IF DimenRec.GET('OPERATIONS', SalesHedd."Shortcut Dimension 2 Code") THEN
                                    TempSalesLine.Description := DimenRec.Name;
                ...
                IF SalesInvHedd.FINDSET THEN
                    REPEAT
                        ...
                        IF DimenRec.GET('OPERATIONS', SalesInvHedd."Shortcut Dimension 2 Code") THEN
                            TempSalesLine.Description := DimenRec.Name;
                    ...
                    REPEAT
                        ...
                        IF SalesCredLine.FINDSET THEN BEGIN
                            REPEAT
                                ...
                                IF DimenRec.GET('OPERATIONS', SalesCredHeddRec."Shortcut Dimension 2 Code") THEN
                                    TempSalesLine.Description := DimenRec.Name;
