report 50095 "Debtor Age Anl Sum- Oper. Wise"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/DebtorAgeAnlSumOperWise.rdl';
    Caption = 'Debtor Age Analysis Summary- By Operation';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempCustLedgEntryLoop; Integer)
                {
                    ...
                    column(CusPostGrp_Cust; CustLedgEntryEndingDate."Global Dimension 2 Code")
                    {
                    }
