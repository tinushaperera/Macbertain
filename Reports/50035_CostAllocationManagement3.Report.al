report 50035 "Cost Allocation Management 3"
{
    ProcessingOnly = true;
    ...
    begin
        ...
        GenJnlLine.SETRANGE("Journal Batch Name", 'COST-MGT-B');
        GenJnlLine.DELETEALL;


        AccPeriod.RESET;
        AccPeriod.SETRANGE("Cost Senario 3 Period", TRUE);
        AccPeriod.FINDLAST;
        ...
        GLAcount.LOCKTABLE;
        GLAcount.RESET;
        GLAcount.SETRANGE("Cost Scenario 3", TRUE);
        GLAcount.FINDFIRST;
        REPEAT
            ...
            GLEntry.SETRANGE("Global Dimension 1 Code", 'DP22');
            ...
            IF GLEntry.FINDFIRST THEN
                REPEAT
                    ...
                    IF (BUICode <> GLEntry."G/L Account No.") THEN BEGIN
                        ...
                        GenJnlLine.VALIDATE(GenJnlLine."Journal Batch Name", 'COST-MGT-B');
                        ...
                        TempGenJnl3."Journal Batch Name" := 'COST-MGT-B';
        ...
        TempGenJnl3.SETRANGE("Journal Batch Name", 'COST-MGT-B');
        IF TempGenJnl3.FINDFIRST THEN BEGIN
            REPEAT
                ...
                GenJnlLineRec.SETRANGE("Journal Batch Name", 'COST-MGT-B');
                ...
                ReCostAllactionJnl.SETRANGE("Journal Batch Name", 'COST-MGT-B');
