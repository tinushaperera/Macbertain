report 50005 "Sales Invoice"
{
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/SalesInvoice.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                IF ("Tax Area Code" = 'SVAT') OR ("Tax Area Code" = 'SVAT/NBT') OR ("Tax Area Code" = 'SVAT/NBT EX') THEN BEGIN
                    Caption := 'SUSPENDED';
                    IF "Posting Date" < 20191201D THEN BEGIN
                    ...
                    ELSE BEGIN
                        //PS
                        SVATAmt := (("Amount Including VAT" * ComRec."SVAT Pecerntage(%)") / 100);//"SVAT %";
                        SVATText := 'Suspended VAT Amount ' + FORMAT(ComRec."SVAT Pecerntage(%)") + '%';
                        //PS
                    END;
                END;
