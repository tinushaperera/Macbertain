report 50049 "Debtor Aged for Board Meeting"
{
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/DebtorAgedforBoardMeeting.rdl';
    Caption = 'Debtor Age Summery Analysis for Board Meeting';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempCustLedgEntryLoop; Integer)
                {
                    DataItemTableView = SORTING(Number)
                                        WHERE(Number = FILTER(1 ..));
                    column(BU_Name; DimensionBUCode.Name)
                    {
                        IncludeCaption = true;
                    }
                    ...
                    column(Operation_Name; DimensionValueOperation.Name)
                    {
                    }
                    ...
                    begin
                        ...
                        IF DetailedCustomerLedgerEntry.FINDSET(FALSE, FALSE) THEN
                            REPEAT
                                IF DimensionBUCode.GET('BUSINESS UNITS', CustLedgEntryEndingDate."Global Dimension 1 Code") THEN;
                                IF DimensionValueOperation.GET('OPERATIONS', CustLedgEntryEndingDate."Global Dimension 2 Code") THEN;
    ...
    var
        ...
        DimensionBUCode: Record "Dimension Value";
        DimensionValueOperation: Record "Dimension Value";
        CustFilter: Text;
