report 50089 "Debtor Age Anly Sum- BU Wise"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/DebtorAgeAnlySumBUWise.rdl';
    Caption = 'Debtor Age Analysis Summary- By BU';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempCustLedgEntryLoop; Integer)
                {
                    ...
                    column(CusPostGrp_Cust; CustLedgEntryEndingDate."Global Dimension 1 Code")
                    {
                    }
                    column(SP_Code; CustLedgEntryEndingDate."Salesperson Code")
                    {
                    }
