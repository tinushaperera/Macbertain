report 50098 "Age Analysis Sales Rep Detail"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/AgeAnalysisSalesRepDetail.rdl';
    Caption = ' Age Analysis Sales Rep Detail';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempCustLedgEntryLoop; Integer)
                {
                    ...
                    column(Sales_Person; Customer."Salesperson Code")
                    {
                    }
                    ...
                    column(Opration_Code; CustLedgEntryEndingDate."Global Dimension 2 Code")
                    {
                    }
                    column(Cheque_Return; Cheque_Return)
                    {
                    }
                    ...
                    column(Sales_Rep; CustLedgEntryEndingDate."Salesperson Code")
                    {
                    }
