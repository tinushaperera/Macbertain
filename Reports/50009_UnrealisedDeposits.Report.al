report 50009 "Unrealised Deposits"
{
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/UnrealisedDeposits.rdl';
    ...
    dataset
    {
        dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
        {
            ...
            column(CreditAmount; Amount)
            {
            }
            column(CreditAmountLCY; "Amount (LCY)")
            {
            }
            ...
            column(DocumnetDate; FORMAT("Document Date"))
            {
            }
            ...
            begin
                ...
                BankAccCode := "Bank Account Ledger Entry".GETFILTER("Bank Account No.");
