report 50097 "Age Analysis Oepration Detail"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report_Layouts/AgeAnalysisOeprationDetail.rdl';
    Caption = 'Age Analysis Details- By Operation';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                RequestFilterFields = "Global Dimension 1 Code", "Global Dimension 2 Code", "Salesperson Code", "Customer No.";
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempCustLedgEntryLoop; Integer)
                {
                    ...
                    column(BU_Code; CustLedgEntryEndingDate."Global Dimension 2 Code")
                    {
                    }
                    ...
                    begin
                        ...
                        IF DetailedCustomerLedgerEntry.FINDSET(FALSE, FALSE) THEN
                            REPEAT
                                IF DimensionCode.GET('OPERATIONS', CustLedgEntryEndingDate."Global Dimension 2 Code") THEN;
