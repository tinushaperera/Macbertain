page 50033 "Import Purchase Order"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Shipping Ref. No."; rec."Shipping Ref. No.")
                {
                    ApplicationArea = all;
                }
            ...
            part("Purchase Order Subform"; "Purchase Order Subform")
            {
                ApplicationArea = All;
        ...
        area(factboxes)
        {
            ...
            {
                Provider = "Purchase Order Subform";
                                ...
                                ELSE BEGIN
                                    ...
                                    IF Comfirmed = TRUE THEN BEGIN
                                        if ApprovalsMgmt.CheckPurchaseApprovalPossible(Rec) then
                                            ApprovalsMgmt.OnSendPurchaseDocForApproval(Rec); //TL
                                    END;
            ...
            group("P&osting")
            {
                ...
                action("Purchaser Order - Import")
                {
                    ...
                    begin
                        ...
                        REPORT.RUNMODAL(50000, TRUE, TRUE, PurchHedd);
                    end;
                }
                action("Post &Batch")
                {
    ...
    begin
        //<CHin 2016/05/09
        rec."Order Type" := rec."Order Type"::Import;
        //>
    ...
    begin
        CurrPage."Purchase Order Subform".PAGE.ApproveCalcInvDisc;
    end;
    ...
    begin
        CurrPage."Purchase Order Subform".PAGE.UpdateForm(TRUE);
    end;
